The Fintech Blueprint Quick Start helps you build a preclinical research enviornment using cloud-based infrastructure on the AWS Cloud, based on industry best practices.  
...
After you deploy the core Quick Start, you can install prepackaged informatics tools from leading Fintech software vendors and open source tools using AWS Service Catalog.
