...
The informatics and scientific tools you can launch after deploying the Quick Start are available to you in the Biotech Blueprint Informatics Catalog of the AWS Service Catalog.  

==== AWS Service Catalog permissions
AWS Service Catalog requires that you explicitly give permissions to individual IAM groups, roles, and users to launch products from a Service Catalog portfolio.
...
. Select the IAM groups, users, and roles to grant permissions to.
+
NOTE: Make sure you add yourself.
